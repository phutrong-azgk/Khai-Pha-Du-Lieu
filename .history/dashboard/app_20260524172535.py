...
st.markdown(
    ...
    /* Custom Card Metric Component (Glassmorphism) */
    .metric-card {
...
if "features" in st.session_state:
    ...
    with tabs[0]:
        ...
        with c_pca2:
            # 🎜 NÂNG CẤP PCA SCATTER CHUYÊN NGHIỆP VỚI WEBGL VÀ AUTO-ZOOM PERCENTILE (Yêu cầu số 4 & 9)
            # Giới hạn tối đa 12,000 điểm mẫu chống lag UI khi render đồ họa nền web
            ...
            fig_pca_after = px.scatter(
                ...
                opacity=0.75,
                render_mode="webgl",  # Sử dụng kiến trúc WebGL cao cấp tăng tốc phần cứng
            ...
            # Khử nhiễu biên của biểu đồ bằng percentile giúp auto-zoom lấp đầy màn hình đẹp mắt
