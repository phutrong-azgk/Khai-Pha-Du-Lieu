...
PIPELINE_CONFIG = {
    "features": {
        ...
        "target_cols": [
            ...
            "Brand_Diversity", "Category_Diversity", "Average_Basket_Value"
        ]
    },
    "preprocessing": {
        "winsor_lower": 0.01,
...
def scale_and_reduce(
    ...
    cols_to_winsorize = ["Recency", "Monetary", "Frequency", "Average_Basket_Value", "Interpurchase_Time"]
    ...
    # Log Transform
    for col in ["Monetary", "Frequency", "Average_Basket_Value", "Brand_Diversity", "Category_Diversity"]:
        if col in X_df.columns:
